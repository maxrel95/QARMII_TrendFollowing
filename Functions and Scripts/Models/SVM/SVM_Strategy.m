...
start = Model.day; % we set the data to adjust compare to the trainning set use, 
...
for time = M+1:21:T
    ...
    % Compute Signal
    [S(position, Ind)] = SVM_Signal(data(time-M:time-1,Ind),Model.classificationSVM, C, F);
